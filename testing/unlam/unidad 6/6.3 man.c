...
int main () {
    ...
    for (int i = 0; i < disparos; ++i) {
        ...
        printf("Ingrese las coordenadas X e Y del disparo Nº%d: ", i + 1);
    ...
    disparostotal_centro += disparoCentro;
    
    printf("Participante %d: Puntaje %d\n", participante, puntaje);
    printf("Cuadrante I: %d. Cuadrante II: %d. Cuadrante III: %d. Cuadrante IV: %d. Centro: %d\n", disparoI, disparoII, disparoIII, disparoIV, disparoCentro);
    ...
    printf("Ganador: Participante Nº%d\n", ganador);
    printf("Puntuacion: %d\n", puntaje_ganador);
    printf("Se realizaron %d disparos en el centro.\n", disparostotal_centro);
